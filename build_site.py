...
<head>
  ...
  <style>
    ...
    .triad .ring { transform-box: fill-box; transform-origin: center; animation: triad-float 7s ease-in-out infinite; }
    .triad .ring-money { animation-delay: -2.3s; } .triad .ring-health { animation-delay: -4.6s; }
    @keyframes triad-float { 0%, 100% { transform: translateY(0); } 50% { transform: translateY(-7px); } }
    @media (prefers-reduced-motion: reduce) { .triad .ring { animation: none; } }
    ...
    @media (max-width: 820px) {
      ...
      .triad-hero { gap: 24px !important; }
      .triad { width: 300px !important; }
...
<div class="grain hero triad-hero" style="position: relative; overflow: hidden; padding: 72px 80px 88px; display: flex; flex-direction: column; align-items: center; text-align: center; gap: 32px; background: radial-gradient(45% 55% at 50% 28%, rgba(242,169,59,0.14) 0%, rgba(242,169,59,0) 70%), radial-gradient(35% 45% at 36% 46%, rgba(95,211,166,0.10) 0%, rgba(95,211,166,0) 70%), radial-gradient(35% 45% at 64% 46%, rgba(240,103,140,0.10) 0%, rgba(240,103,140,0) 70%), #0A0D14;">
  <svg class="triad" viewBox="0 0 440 360" width="440" height="360" role="img" aria-label="Three overlapping rings labelled Time, Money and Health" style="display: block; max-width: 100%; height: auto; overflow: visible;">
    <defs>
      <filter id="tglow" x="-50%" y="-50%" width="200%" height="200%"><feGaussianBlur stdDeviation="14" result="b"></feGaussianBlur><feMerge><feMergeNode in="b"></feMergeNode><feMergeNode in="SourceGraphic"></feMergeNode></feMerge></filter>
    </defs>
    <g class="ring ring-time"><circle cx="220" cy="118" r="98" fill="rgba(242,169,59,0.05)" stroke="#F2A93B" stroke-width="3" filter="url(#tglow)"></circle><text x="220" y="6" text-anchor="middle" fill="#F2A93B" font-family="Sora, 'Avenir Next', Helvetica, Arial, sans-serif" font-weight="700" font-size="15" letter-spacing="2.2">TIME</text></g>
    <g class="ring ring-money"><circle cx="130" cy="218" r="98" fill="rgba(95,211,166,0.05)" stroke="#5FD3A6" stroke-width="3" filter="url(#tglow)"></circle><text x="80" y="346" text-anchor="middle" fill="#5FD3A6" font-family="Sora, 'Avenir Next', Helvetica, Arial, sans-serif" font-weight="700" font-size="15" letter-spacing="2.2">MONEY</text></g>
    <g class="ring ring-health"><circle cx="310" cy="218" r="98" fill="rgba(240,103,140,0.05)" stroke="#F0678C" stroke-width="3" filter="url(#tglow)"></circle><text x="360" y="346" text-anchor="middle" fill="#F0678C" font-family="Sora, 'Avenir Next', Helvetica, Arial, sans-serif" font-weight="700" font-size="15" letter-spacing="2.2">HEALTH</text></g>
  </svg>
  <div class="hero-text" style="display: flex; flex-direction: column; align-items: center; gap: 22px; max-width: 900px; position: relative; z-index: 1;">
    <h1 style="font-size: 64px; font-weight: 800; line-height: 1.05;">You can't optimize one without affecting the others.</h1>
    <p style="font-size: 20px; line-height: 1.6; color: #B7BFCC; max-width: 620px;">Three Elements builds small, beautiful iPhone apps around that one idea. Steal a routine from the world's best. Then focus on three things a day.</p>
  </div>
  <div class="btn-row app-pills" style="display: flex; gap: 16px; flex-wrap: wrap; justify-content: center; position: relative; z-index: 1;">
    <a class="btn" href="https://apps.apple.com/us/app/celebrity-routines/id6755641471" style="display: inline-flex; align-items: center; gap: 12px; height: 60px; padding: 0 22px 0 10px; border-radius: 999px; background: #121722; border: 1px solid rgba(255,255,255,0.1); color: #F4F5F7; font-weight: 600; font-size: 16px;"><img src="img/icon-routines.png" alt="" width="40" height="40" style="border-radius: 11px;">Celebrity Routines<span style="color: #F2A93B; display: inline-flex;">{ICON_ARROW}</span></a>
    <a class="btn" href="https://apps.apple.com/us/app/focus-daily-goals/id6760952606" style="display: inline-flex; align-items: center; gap: 12px; height: 60px; padding: 0 22px 0 10px; border-radius: 999px; background: #121722; border: 1px solid rgba(255,255,255,0.1); color: #F4F5F7; font-weight: 600; font-size: 16px;"><img src="img/icon-focus.png" alt="" width="40" height="40" style="border-radius: 11px;">Focus: Daily Goals<span style="color: #9B5CFF; display: inline-flex;">{ICON_ARROW}</span></a>
  </div>
  <div class="checks" style="display: flex; align-items: center; justify-content: center; gap: 28px; color: #8E97A8; font-size: 14px; flex-wrap: wrap;">
    ...
    <span style="display: inline-flex; align-items: center; gap: 8px;">{ICON_CHECK}Focus is completely free</span>
  </div>
</div>
